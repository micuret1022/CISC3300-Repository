...
it is exectued on the server and generates HTML [or other outputs] to the client. */
...
listens to user input, through views, and performs interations on the data model objects. Some of its responsibilities
include: recieving input, validating input, processing user commands, and determining the next output to present 
